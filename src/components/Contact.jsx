    ...
    <div name="contact" className='w-full h-screen bg-gradient-to-b from-black to-gray-800
      ...
      <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
        ...
        <div className='flex justify-center items-center'>
            <form action="https://getform.io/f/8ec97314-b658-4fc2-a5d0-243684c05bfa" method='POST' className='flex flex-col w-full md:w-1/2'>
              ...
              <input type='text' name="email" placeholder='Enter your email' className='my-4 p-2 bg-transparent border-2
              rounded-md text-white focus:outline-none'/>
              <textarea name="message" placeholder="Enter your message" rows="" className='p-2 bg-transparent border-2 rounded-md text-white focus:outline-none'></textarea>
